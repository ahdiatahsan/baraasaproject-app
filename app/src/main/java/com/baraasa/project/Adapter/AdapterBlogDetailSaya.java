...
import com.baraasa.project.Blog.Blog_Detail_Saya;
import com.baraasa.project.Model.BlogModel;

import java.util.ArrayList;

public class AdapterBlogDetailSaya extends RecyclerView.Adapter<AdapterBlogDetailSaya.ViewHolder> {

    private ArrayList<BlogModel> blogModels;
    Context context;
    DataBlog dataBlog;

    public AdapterBlogDetailSaya(ArrayList<BlogModel> blogModels, Context context) {
    ...
    public void onBindViewHolder(@NonNull final ViewHolder holder, @SuppressLint("RecyclerView") final int position) {
        ...
        Glide.with(context)
                .load(img1)
                .into(holder.blog_cover_image);
        holder.cardView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                context.startActivity(new Intent(context, Blog_Detail_Saya.class)
...
//                    materiList = liat;
//                } else {
//                    ArrayList<Materi> filteredList = new ArrayList<>();
//                    for (Materi model : materiList) {
//                        if (model.getJudul().toLowerCase().contains(searchString)) {
//                            filteredList.add(model);
//                        } else if (model.getJudul().toUpperCase().contains(searchString)) {
//                            filteredList.add(model);
//                        }
//                    }
//                    materiList = filteredList;
//                }
//                FilterResults filterResults = new FilterResults();
//                filterResults.values = materiList;
//
...
//                    materiList = (ArrayList<Materi>) results.values;
//                    notifyDataSetChanged();
//            }
//        };
//    }
