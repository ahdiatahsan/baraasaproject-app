...
public class AdapterBlogSearch extends RecyclerView.Adapter<AdapterBlogSearch.ViewHolder> {

    private ArrayList<BlogModelSearch> blogModels;
    private ArrayList<BlogModelSearch> liat;
    Context context;
    DataBlog dataBlog;



    public AdapterBlogSearch(ArrayList<BlogModelSearch> blogModels, Context context) {
        ...
        return new Filter() {
            ...
            protected FilterResults performFiltering(CharSequence constraint) {
                ...
                if (searchString.isEmpty()) {
                    ...
                    ArrayList<BlogModelSearch> filteredList = new ArrayList<>();
                    for (BlogModelSearch model : blogModels) {
            ...
            protected void publishResults(CharSequence constraint, FilterResults results) {
                if (results.count == 0) {
                    blogModels = (ArrayList<BlogModelSearch>) results.values;
                    notifyDataSetChanged();
                }
            }
        };
