...
public class AdapterForumSearch extends RecyclerView.Adapter<AdapterForumSearch.ViewHolder> {

    private ArrayList<ThreadModelSearch> threadModels;
    Context context;
    DataThread dataThread;

    public AdapterForumSearch(ArrayList<ThreadModelSearch> threadModels, Context context) {
    ...
    public Filter getFilter() {
        return new Filter() {
            ...
            protected FilterResults performFiltering(CharSequence constraint) {
                ...
                ArrayList<ThreadModelSearch> filteredList = new ArrayList<>();
                for (ThreadModelSearch model : threadModels) {
            ...
            protected void publishResults(CharSequence constraint, FilterResults results) {
                if (results.count == 0) {
                    threadModels = (ArrayList<ThreadModelSearch>) results.values;
                    notifyDataSetChanged();
                }
            }
        };
