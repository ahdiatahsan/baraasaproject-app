...
public class Blog_Tambah extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_blog_tambah);

        getSupportActionBar().hide();
        toolbar = (Toolbar) findViewById(R.id.toolbartambahblog);
        toolbar.setTitle("Tambah Blog");
        ...
        toolbar.setOnMenuItemClickListener(new Toolbar.OnMenuItemClickListener() {
            ...
            public boolean onMenuItemClick(MenuItem item) {
                if (item.getItemId() == R.id.action_ceklis) {
                    Toast.makeText(Blog_Tambah.this, "Tambah", Toast.LENGTH_SHORT).show();
                }
                return false;
            }
        });
...
//
//        Judul = findViewById(R.id.judulBlog);
//        Thumbnail = findViewById(R.id.thumbnailBlog);
